...
liner_search(string_list[9999], string_list)
end_time = time_counter()
execute_time = (end_time - start_time)*1000
print(f'liner search execution time for 10000 sorted string data set : {round(execute_time, 7)} ms\n')

start_time = time_counter()
binary_search(string_list, string_list[9999], 0, len(string_list)-1)
end_time = time_counter()
execute_time = (end_time - start_time)*1000
print(f'binary search execution time for 10000 sorted string data set : {round(execute_time, 7)} ms\n')

start_time = time_counter()
jump_search(string_list[9999], string_list)
end_time = time_counter()
execute_time = (end_time - start_time)*1000
print(f'jump search execution time for 10000 sorted string data set : {round(execute_time, 7)} ms\n')

start_time = time_counter()
exponential_search(string_list[9999], string_list)
end_time = time_counter()
execute_time = (end_time - start_time)*1000
print(f'exponential search execution time for 10000 sorted string data set : {round(execute_time, 7)} ms\n')